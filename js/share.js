...
function wIShare(post_title) {
  window.location = 'whatsapp://send?text=' + post_title + '%0A' + window.location.hostname + '/intro.html';
}
function tIShare(post_title) {
  window.open ('https://twitter.com/intent/tweet?text=' + post_title + '%0A' + window.location.hostname + '/intro.html');
}
function mIShare(post_title) {
  window.open ('fb-messenger://share?link=' + post_title + '%0A' + window.location.hostname + '/intro.html');
}
function fIShare(post_title) {
  window.open ('https://facebook.com/sharer/sharer.php?u=' + post_title + '%0A' + window.location.hostname + '/intro.html');
}
function lIShare(post_title) {
  window.open ('https://linkedin.com/shareArticle?mini=true&url=' + post_title + '%0A' + window.location.hostname + '/intro.html' + "%0A%0A" + '&summary=' + document.getElementsByTagName("meta")[5].content);
}
function gIShare(post_title) {
  window.open ('https://plus.google.com/share?url=' + post_title + '%0A' + window.location.hostname + '/intro.html');
}
function eIShare(post_title) {
  window.open ('mailto:?subject=' + post_title + '&body=Thought you might like this: %0A%0A' + window.location.hostname + '/intro.html' + "%0A%0A" + 'by Zi R. Lem, Screenwriter-Filmmaker');
}
